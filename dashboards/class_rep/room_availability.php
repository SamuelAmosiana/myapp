<?php
/**
 * Class Rep Room Availability Dashboard - ClassReserve CHAU
 * File: dashboards/class_rep/room_availability.php
 */
...
<head>
    ...
    <title>Room Availability - Class Rep Dashboard</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        .availability-card.bookable {
            border-left: 5px solid var(--success-color);
        }

        .availability-card.occupied {
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-10">
                    <div class="main-content">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h2><i class="fas fa-eye text-success"></i> Room Availability Overview</h2>
                                <p class="text-muted">Check real-time room availability to make informed booking decisions</p>
                            </div>
                        </div>

                        <!-- Booking Tip -->
                        <div class="booking-tip">
                            <h6><i class="fas fa-lightbulb text-warning"></i> Smart Booking Tips</h6>
                            <ul class="mb-0">
                                <li><strong>Green rooms</strong> are available now - perfect for immediate bookings</li>
                                <li><strong>Yellow rooms</strong> are available but have upcoming bookings - book wisely</li>
                                <li><strong>Red rooms</strong> are currently in use - check when they'll be free</li>
                                <li>Use this page before booking to avoid conflicts and save time!</li>
                            </ul>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4 class="mb-4"><i class="fas fa-building"></i> Room Status & Booking Options</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <?php foreach ($roomAvailability as $room): ?>
                                <div class="col-lg-6 col-xl-4 mb-4">
                                    <div class="availability-card <?php echo ($room['availability_status'] === 'occupied') ? 'occupied' : 'bookable'; ?>">
                                        ...
                                        <?php if ($room['availability_status'] === 'occupied'): ?>
                                            <div class="booking-info occupied">
                                                ...
                                                <small class="text-info">
                                                    <i class="fas fa-info-circle"></i> This room will be available after <?php echo date('H:i', strtotime($room['current_end'])); ?>
                                                </small>
                                            </div>
                                            ...
                                            <div class="booking-info available">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <small class="text-warning">
                                                        <i class="fas fa-exclamation-triangle"></i> Book before <?php echo date('H:i', strtotime($room['next_start'])); ?>
                                                    </small>
                                                    <a href="book_room.php?room_id=<?php echo $room['room_id']; ?>" class="book-now-btn">
                                            ...
                                            <div class="booking-info available">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <small class="text-success">
                                                        <i class="fas fa-thumbs-up"></i> Perfect for flexible scheduling
                                                    </small>
                                                    <a href="book_room.php?room_id=<?php echo $room['room_id']; ?>" class="book-now-btn">
                                                        <i class="fas fa-plus"></i> Book Now
                                                    </a>
                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                <h4 class="mb-4"><i class="fas fa-calendar-day"></i> Today's Complete Schedule</h4>
                                            ...
                                            <?php if (empty($todayBookings)): ?>
                                                <tr>
                                                    <td colspan="5" class="text-center text-muted py-4">
                                                        ...
                                                        No bookings scheduled for today - all rooms are available!
                                                    </td>
                                                </tr>
                                            <?php else: ?>
